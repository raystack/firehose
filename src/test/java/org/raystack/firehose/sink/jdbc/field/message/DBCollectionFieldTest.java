...
import org.raystack.firehose.consumer.TestReason;
...
public class DBCollectionFieldTest {
    ...
    public void shouldParseTheCollectionFieldAsString() throws Exception {
        ...
        DynamicMessage feedbackParsed = stencilClient.getParser("org.raystack.firehose.consumer.TestFeedbackLogMessage").parse(feedback.toByteArray());
