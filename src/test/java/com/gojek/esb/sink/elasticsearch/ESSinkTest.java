...
public class ESSinkTest {
    ...
    public void setUp() {
        ...
        esRequestBuilder = new ESRequestBuilder(ESRequestType.INSERT_OR_UPDATE, esSinkConfig.getEsIdFieldName(), true,
                esSinkConfig.getESMessageType(), jsonDeserializer);
    ...
    public void shouldPushProtoMessageToES() throws IOException, DeserializerException {
        ...
        esbMessages.add(esbMessage1);
        esbMessages.add(esbMessage2);
        when(jsonDeserializer.getParsedJsonMessage(esbMessage1, true)).thenReturn(jsonObject.toJSONString());
        when(jsonDeserializer.getParsedJsonMessage(esbMessage2, true)).thenReturn(jsonObject2.toJSONString());
        try {
            esSink.pushMessage(esbMessages);
        } catch (DeserializerException e) {
            e.printStackTrace();
    ...
    public void shouldPushProtoMessageToESWithoutPreservingProtoFieldNames() throws IOException, DeserializerException {
        ...
        esSinkConfig = ConfigFactory.create(ESSinkConfig.class, configuration);
        esSinkClient = new ESSinkClient(esSinkConfig, client);
        esRequestBuilder = new ESRequestBuilder(ESRequestType.INSERT_OR_UPDATE, esSinkConfig.getEsIdFieldName(), false,
                esSinkConfig.getESMessageType(), jsonDeserializer);
        esSink = new ESSink(esRequestBuilder, esSinkClient, type, index);
        ...
        esbMessages.add(esbMessage1);
        esbMessages.add(esbMessage2);
        when(jsonDeserializer.getParsedJsonMessage(esbMessage1, false)).thenReturn(jsonObject.toJSONString());
        when(jsonDeserializer.getParsedJsonMessage(esbMessage2, false)).thenReturn(jsonObject2.toJSONString());
        try {
            esSink.pushMessage(esbMessages);
        } catch (DeserializerException e) {
            e.printStackTrace();
    ...
    public void shouldPushMessageToESByUpdateOnlyMode() throws IOException {
        esRequestBuilder = new ESRequestBuilder(ESRequestType.UPDATE_ONLY, esSinkConfig.getEsIdFieldName(), true,
                esSinkConfig.getESMessageType(), jsonDeserializer);
        esSink = new ESSink(esRequestBuilder, esSinkClient, type, index);
