...
public class ESUpsertRequestHandlerTest {
    ...
    public void shouldReturnTrueForInsertMode() {
        ESUpsertRequestHandler esUpsertRequestHandler = new ESUpsertRequestHandler(
                ESMessageType.JSON, jsonSerializer, "customer", "booking", ESRequestType.INSERT_OR_UPDATE, "customer_id", "vehicle_type");
    ...
    public void shouldReturnFalseForUpdateOnlyMode() {
        ESUpsertRequestHandler esUpsertRequestHandler = new ESUpsertRequestHandler(ESMessageType.JSON, jsonSerializer, "customer", "booking", ESRequestType.UPDATE_ONLY, "customer_id", "vehicle_type");
    ...
    public void shouldReturnInsertRequestHandlerForJsonMessageType() {
        ESUpsertRequestHandler esUpsertRequestHandler = new ESUpsertRequestHandler(ESMessageType.JSON, jsonSerializer, "customer", "booking", ESRequestType.INSERT_OR_UPDATE, "customer_id", "vehicle_type");
