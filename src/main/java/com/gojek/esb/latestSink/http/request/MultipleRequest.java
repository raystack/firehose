...
import com.gojek.esb.latestSink.http.request.header.SupportParamerizedHeader;
import com.gojek.esb.latestSink.http.request.uri.SupportParameterizedUri;
...
/**
 * MultipleRequest create multiple HttpPut per-message. Uri and Header are
