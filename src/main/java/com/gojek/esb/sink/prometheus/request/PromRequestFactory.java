...
public class PromRequestFactory {
    ...
    public PromRequestFactory(StatsDReporter statsDReporter, PrometheusSinkConfig prometheusSinkConfig, ProtoParser protoParser, UriParser uriParser) {
    ...
    public PromRequest createRequest() {
        ...
        PromRequest request = new PromRequest(statsDReporter, body);

        return request.setRequest(headerBuilder, uriBuilder, requestEntityBuilder);
    }
