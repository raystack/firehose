...
import com.gojek.esb.sink.db.field.message.DBCollectionField;
import com.gojek.esb.sink.db.field.message.DBDefaultMessageField;
import com.gojek.esb.sink.db.field.message.DBTimestampField;
