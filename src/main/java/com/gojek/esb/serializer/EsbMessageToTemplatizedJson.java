...
public class EsbMessageToTemplatizedJson implements EsbMessageSerializer {
    ...
    public static EsbMessageToTemplatizedJson create(Instrumentation instrumentation, String httpSinkJsonBodyTemplate, ProtoParser protoParser) {
        EsbMessageToTemplatizedJson esbMessageToTemplatizedJson = new EsbMessageToTemplatizedJson(instrumentation, httpSinkJsonBodyTemplate, protoParser);
    ...
    public EsbMessageToTemplatizedJson(Instrumentation instrumentation, String httpSinkJsonBodyTemplate, ProtoParser protoParser) {
